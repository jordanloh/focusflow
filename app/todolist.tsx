    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.bottomNav}>
          <BottomTab icon="home" label="Home" active={false} />
          <BottomTab icon="calendar" label="Timetable" active={false} />
          <BottomTab icon="list" label="To-Do" active={true} />
          <BottomTab icon="user" label="Profile" active={false} />
        </View>
      </View>
    </SafeAreaView>
  );
